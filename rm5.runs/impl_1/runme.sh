...
HD_PWD='C:/Users/gotar/rm5/rm5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_moore.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_moore.tcl -notrace
