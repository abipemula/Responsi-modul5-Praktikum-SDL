...
HD_PWD='C:/Users/gotar/rm5/rm5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_moore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_moore.tcl
